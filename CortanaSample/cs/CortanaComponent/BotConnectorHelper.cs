...
{
    internal static class BotConnectorHelper
    {
        static string botId = "ThirusHelloWorldBot";
        static HttpClient client;
        static string convId;
        static HttpResponseMessage response;

        static BotConnectorHelper()
        {
        ...
        public static async Task<string> SendAndReceive(string input)
        {
            ...
            try
            {
                ...
                if (client == null)
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", "OAP9jxCcQkA.cwA.Mmk.QXdnkdYRPyOdmV3wj4wUBUS8Rvwt0rLgXQ4vnR57fX0");
